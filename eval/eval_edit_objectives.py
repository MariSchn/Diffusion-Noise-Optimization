...
def main():
    ...
    print(f"Using objective_loss: {args.objective_loss} with sigma: {args.objective_sigma} (only for german mcclure/cauchy)")
    ...
    for ii in range(num_total_batches):
        ...
        if os.path.exists(batch_path):
            ...
            loss_fn = CondKeyLocationsLoss(
                ...
                abs_3d=False,
                objective_loss=args.objective_loss,
                objective_sigma=args.objective_sigma,
